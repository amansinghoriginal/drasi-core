...
### Backend Plugin
*   **`IndexSet`**: Groups all four index types (`ElementIndex`, `ElementArchiveIndex`, `ResultIndex`, `FutureQueue`) into a single unit, enabling backends to create them from a shared resource.
